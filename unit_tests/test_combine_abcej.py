...
from cmap.clqt_jax import combine_abcej_backward
...
def test_combine_abcej_identity():
    ...
    left = combine_abcej_backward(ident, elem)
    right = combine_abcej_backward(elem, ident)
...
def test_combine_abcej_composition_and_associativity():
    ...
    A_out, b_out, C_out, eta_out, J_out = combine_abcej_backward(elem1, elem2)
    ...
    left = combine_abcej_backward(combine_abcej_backward(elem1, elem2), elem3)
    right = combine_abcej_backward(elem1, combine_abcej_backward(elem2, elem3))
